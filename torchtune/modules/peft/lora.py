...
class LoRALinear2(nn.Module, AdapterModule):
    ...
    Args:
        ...
        quantize_base (bool): Whether to quantize base linear weight or not.
            Default: False
        decompose (bool): Decompose the weights into two components, magnitude and direction,
            as introduced in "DoRA: Weight-Decomposed Low-Rank Adaptation" (https://arxiv.org/abs/2402.09353).
            Default: False
    """
    ...
    def adapter_params(self) -> List[str]:
        """
        Return a list of adapter params.
